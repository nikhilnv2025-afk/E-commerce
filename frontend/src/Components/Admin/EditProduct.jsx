...
const handleImageUpload =async (e)=>{
    ...
    try{
        ...
        const {data} = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/upload`,formData,{
            headers:{"Content-Type":"multipart/form-data"} // we will upload file here
        })
        setProductData((prevData)=>({
            ...prevData,
...
<div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
    ...
    <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
            ...
            <textarea name="description" value={productData.description} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2" required rows={4} />
        </div>
        {/* Price Input */}
        <div className="mb-6">
